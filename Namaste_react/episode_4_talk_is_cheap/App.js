...
const RestaurantCard = (props)=>{
    ...
    return (
        <div className="res-card">
            <img className="res-logo" alt = "restaurant logo" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/yyhhrh30ltteygw6l3pq"/>
            <h3>{resName}</h3>
            <h4>{cuisines}</h4>
            <h4>4.5</h4>
            <h4>7 minutes</h4>
...
const Body = () => {
    return (
        <div className="body">
            ...
            <RestaurantCard resName="Foodcapital" cuisines="Biryani , asian, chinese"/>
            <RestaurantCard resName="Megana Foods" cuisines="japnese, westren"/>
            </div>
        </div>
    );
}
